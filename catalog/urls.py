...
from catalog.views import ProductListView, ContactView, ProductDetailView, ProductCreateView, ProductUpdateView, \
    ProductCategoryView, ProductDeleteView, ProductHideView
...
urlpatterns = [
    ...
    path('hide/<int:pk>/', ProductHideView.as_view(), name='product_hide'),
    path('products/category/', ProductCategoryView.as_view(), name='product_category')
]
